                ...
                {colLeads.map((lead) => {
                  ...
                  return (
                    <div
                      ...
                      onClick={() => { if (draggingId !== lead.id) setSelectedLeadId(lead.id); }}
                      className="bg-card border border-border rounded-md p-3 cursor-pointer shadow-sm hover:shadow transition-shadow"
                    >

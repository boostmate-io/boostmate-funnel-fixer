...
interface ComponentUIRendererProps {
  ...
  outputStructure?: Array<{ key: string; label: string; type: string; role?: string; item_schema?: any[]; is_primary?: boolean }>;
...
const ComponentUIRenderer = ({
  ...
  switch (uiInterfaceSlug) {
    ...
    case "authority_context_insight_ui":
      return <AuthorityContextInsightUI {...props} />;
    case "risk_reversal_guarantee_ui":

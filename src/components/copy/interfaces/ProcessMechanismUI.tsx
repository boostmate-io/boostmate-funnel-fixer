  ...
  const handleGenerate = async () => {
    ...
    try {
      const result = await executeAIAction({
        ...
        extraInstructions: buildCopyExtraInstructions("process-mechanism", componentInstructions),
        outputStructure,
      });
  ...
  const handleRegenerateField = async (fieldKey: string) => {
    ...
    try {
      ...
      const result = await executeAIAction({
        slug: aiActionSlug,
        inputs: { ...inputs, context },
        extraInstructions: buildCopyExtraInstructions("process-mechanism", focus, { focusFieldKey: fieldKey }),
        outputStructure,
      });

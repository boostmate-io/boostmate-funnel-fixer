  ...
  const handleGenerate = async () => {
    ...
    try {
      const result = await executeAIAction({
        ...
        extraInstructions: buildCopyExtraInstructions("additional-results-proof", componentInstructions),
        outputStructure,
      });
  ...
  const handleRegenerateField = async (fieldKey: string) => {
    ...
    try {
      ...
      const result = await executeAIAction({
        slug: aiActionSlug,
        inputs: { ...inputs, context },
        extraInstructions: buildCopyExtraInstructions("additional-results-proof", focus, { focusFieldKey: fieldKey }),
        outputStructure,
      });

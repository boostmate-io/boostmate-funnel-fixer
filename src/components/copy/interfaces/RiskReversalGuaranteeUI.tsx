  ...
  const handleGenerate = async () => {
    ...
    try {
      const result = await executeAIAction({
        ...
        extraInstructions: buildCopyExtraInstructions("risk-reversal-guarantee", componentInstructions),
        outputStructure,
      });
  ...
  const handleRegenerateField = async (fieldKey: string) => {
    ...
    try {
      ...
      const result = await executeAIAction({
        slug: aiActionSlug,
        inputs: { ...inputs, context },
        extraInstructions: buildCopyExtraInstructions("risk-reversal-guarantee", focus, { focusFieldKey: fieldKey }),
        outputStructure,
      });

// =============================================================================
// FrameworkSection — Tab 1 builder for the Signature Framework.
// Method name + brief description + dynamic pillar cards (accordion).
  ...
  return (
    <div className="rounded-xl border border-border bg-card overflow-hidden">
      <div className="px-5 py-4 border-b border-border flex items-start gap-3">
        ...
        <div>
          <h3 className="text-lg font-display font-bold text-foreground">Signature Framework</h3>
          ...
          {pillars.length === 0 ? (
            <div className="rounded-lg border border-dashed border-border bg-muted/30 px-4 py-6 text-center">
              <p className="text-sm text-muted-foreground mb-2">
                Map the core pillars of your method.
              </p>

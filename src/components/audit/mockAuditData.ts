...
export const mockCurrentFunnel: FunnelDiagram = {
  nodes: [
    ...
    },
    {
      ...
      type: "funnelNode",
      position: { x: 200, y: 50 },
      data: { label: "funnelDesigner.pages.optIn", pageType: "opt-in", icon: "FileText", color: "#3B82F6" },
    },
    {
      id: "page-2",
      type: "funnelNode",
      position: { x: 450, y: 50 },
      data: { label: "funnelDesigner.pages.webinar", pageType: "webinar", icon: "Video", color: "#EC4899" },
    },
    {
      id: "page-3",
      type: "funnelNode",
      position: { x: 700, y: 50 },
      data: { label: "funnelDesigner.pages.sales", pageType: "sales", icon: "FileText", color: "#F59E0B" },
    },
  ],
  edges: [
...
export const mockOptimizedFunnel: FunnelDiagram = {
  nodes: [
    ...
    },
    {
      ...
      type: "funnelNode",
      position: { x: 200, y: 50 },
      data: { label: "funnelDesigner.pages.squeeze", pageType: "squeeze", icon: "Zap", color: "#8B5CF6" },
    },
    {
      id: "page-2",
      type: "funnelNode",
      position: { x: 450, y: 50 },
      data: { label: "funnelDesigner.pages.bridge", pageType: "bridge", icon: "ArrowRight", color: "#10B981" },
    },
    {
      id: "page-3",
      type: "funnelNode",
      position: { x: 700, y: 50 },
      data: { label: "funnelDesigner.pages.calendar", pageType: "calendar", icon: "Calendar", color: "#6366F1" },
    },
    {
      id: "page-4",
      type: "funnelNode",
      position: { x: 700, y: 200 },
      data: { label: "funnelDesigner.pages.thankYou", pageType: "thank-you", icon: "Heart", color: "#EC4899" },
    },
  ],
  edges: [
    { id: "e1", source: "traffic-1", target: "page-1" },
